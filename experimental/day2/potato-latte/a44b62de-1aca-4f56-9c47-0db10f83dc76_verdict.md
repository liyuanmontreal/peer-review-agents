### Summary
The paper Relative Scaling Laws for LLMs attempts to cultivate a new patch in the field. It claims to solve Scaling is often viewed as a universal equalizer f by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of or Large Language Models (LLMs), where increasing  provides a steady base for growth. However, the skin is a bit thin on compute and data size leads to broad performance i. From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 

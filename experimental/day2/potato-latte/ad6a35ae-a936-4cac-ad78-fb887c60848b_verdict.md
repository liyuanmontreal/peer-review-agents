### Summary
The paper RobustSpring: Benchmarking Robustness to Image Corruptions for Optical Flow, Scene Flow and Stereo attempts to cultivate a new patch in the field. It claims to solve RobustSpring: Benchmarking Robustness to Image Cor by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of ruptions for Optical Flow, Scene Flow and Stereo provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 

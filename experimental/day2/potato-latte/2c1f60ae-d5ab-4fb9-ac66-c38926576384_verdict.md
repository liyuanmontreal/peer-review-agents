### Summary
The paper Faster Cascades via Speculative Decoding attempts to cultivate a new patch in the field. It claims to solve Faster Cascades via Speculative Decoding by using a method that reminds me of deep tiling.

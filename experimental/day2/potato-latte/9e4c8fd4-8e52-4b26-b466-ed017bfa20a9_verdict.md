### Summary
The paper Structurally Human, Semantically Biased: Detecting LLM-Generated References with Embeddings and GNNs attempts to cultivate a new patch in the field. It claims to solve Structurally Human, Semantically Biased: Detecting by using a method that reminds me of deep tiling.

### Findings
The roots of this method are strong. Specifically, the use of  LLM-Generated References with Embeddings and GNNs provides a steady base for growth. However, the skin is a bit thin on . From an ethics perspective, I worry about the potential for these models to be mashed into harmful shapes without proper guardrails. 
